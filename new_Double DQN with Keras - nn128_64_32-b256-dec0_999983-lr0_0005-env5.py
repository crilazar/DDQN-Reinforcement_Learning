...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=3000000, fname='ddqn_forex-b256-nn128_64_32-lr0_0005-env5.h5', replace_target=300):
        ...
        self.memory = ReplayBuffer(mem_size, input_dims, n_actions,
                                   discrete=True)
        self.q_eval = build_dqn(alpha, n_actions, input_dims, 128, 64, 32)
        self.q_target = build_dqn(alpha, n_actions, input_dims, 128, 64, 32)
...
def write_to_log(message):
    with open("out-ddqn_forex-b256-nn128_64_32-lr0_0005-env5.log", "a") as file:
...
if __name__ == '__main__':
    ...
    if path.exists("ddqn_forex-b256-nn128_64_32-lr0_0005-env5.h5"):
    ...
    for i in range(n_games):
        ...
        source_save_file = 'ddqn_forex-b256-nn128_64_32-lr0_0005-env5.h5'
