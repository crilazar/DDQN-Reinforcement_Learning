...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=1000000, fname='ddqn_forex-b256-nn512_128-lr0_0005.h5', replace_target=100):
...
if __name__ == '__main__':
    ...
    ddqn_agent = DDQNAgent(alpha=0.0005, gamma=0.99, n_actions=4, epsilon=1.0,
                  batch_size=256, input_dims=41)
    n_games = 1000    
    ddqn_scores = []
    eps_history = []
    
    #os.chdir('..')
    #source_load_file = 'gdrive/My Drive/RL_models/ddqn_forex-b256-nn512_128-lr0_0005.h5'
    #dest_load_file = 'ddqn_forex-b256-nn512_128-lr0_0005.h5'
    #shutil.copy2(source_load_file, dest_load_file)
    if path.exists("ddqn_forex-b256-nn512_128-lr0_0005.h5"):
    ...
    for i in range(n_games):
        ...
        source_save_file = 'ddqn_forex-b256-nn512_128-lr0_0005.h5'
