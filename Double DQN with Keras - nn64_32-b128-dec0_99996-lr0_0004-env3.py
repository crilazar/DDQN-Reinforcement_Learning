...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=1000000, fname='ddqn_forex-b128-nn64_32-lr0_0004-env3.h5', replace_target=100):
...
def write_to_log(message):
    with open("out-ddqn_forex-b128-nn64_32-lr0_0004-env3.log", "a") as file:
...
if __name__ == '__main__':
    ...
    if path.exists("ddqn_forex-b128-nn64_32-lr0_0004-env3.h5"):
    ...
    for i in range(n_games):
        ...
        source_save_file = 'ddqn_forex-b128-nn64_32-lr0_0004-env3.h5'
