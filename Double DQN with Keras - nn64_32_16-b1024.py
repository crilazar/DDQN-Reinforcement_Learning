...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=1000000, fname='ddqn_forex-b1024-nn64_32_16-lr0_0005.h5', replace_target=100):
        ...
        self.memory = ReplayBuffer(mem_size, input_dims, n_actions,
                                   discrete=True)
        self.q_eval = build_dqn(alpha, n_actions, input_dims, 64, 32, 16)
        self.q_target = build_dqn(alpha, n_actions, input_dims, 64, 32, 16)
...
def write_to_log(message):
    with open("out-ddqn_forex-b1024-nn64_32_16-lr0_0005.log", "a") as file:
...
if __name__ == '__main__':
    ...
    ddqn_agent = DDQNAgent(alpha=0.0005, gamma=0.99, n_actions=4, epsilon_dec=0.9996, epsilon=1.0, batch_size=1024, input_dims=41)
    n_games = 1000    
    ddqn_scores = []
    eps_history = []
    ...
    if path.exists("ddqn_forex-b1024-nn64_32_16-lr0_0005.h5"):
    ...
    for i in range(n_games):
        ...
        source_save_file = 'ddqn_forex-b1024-nn64_32_16-lr0_0005.h5'
