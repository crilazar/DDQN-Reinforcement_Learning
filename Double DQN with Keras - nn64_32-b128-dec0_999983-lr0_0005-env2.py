...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=2000000, fname='ddqn_forex-b128-nn64_32-lr0_0005-env2.h5', replace_target=500):
...
import numpy as np
from env.forex_env_v2 import Forex1 as ForexTrading
...
def write_to_log(message):
    with open("out-ddqn_forex-b128-nn64_32-lr0_0005-env2.log", "a") as file:
...
if __name__ == '__main__':
    ...
    if path.exists("ddqn_forex-b128-nn64_32-lr0_0005-env2.h5"):
    ...
    for i in range(n_games):
        ...
        source_save_file = 'ddqn_forex-b128-nn64_32-lr0_0005-env2.h5'
